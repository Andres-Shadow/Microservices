Feature: La API proporsional al usuario la funcinalidad de eliminar un usuario
  ...
  Scenario: pepe desea eliminar un registro en la base de datos
    Given pepe proporsiona su correo electrónico en el parámetro de la URL
    When pepe hace una petición DELETE a /api/v1/users/:email
  ...
  Scenario: pepe desea eliminar un registro en la base de datos
    Given pepe no proporsiona un correo electrónico valido en el parámetro de la URL
    When pepe hace una petición DELETE a /api/v1/users/:email
    And el mensaje de respuesta del servidor contiene un estado 404

  Scenario: pepe desea eliminar un registro en la base de datos
    Given pepe no proporsiona un correo electrónico en el parámetro de la URL
    When pepe hace una petición DELETE a /api/v1/users/:email
    And el mensaje de respuesta del servidor contiene un estado 404
